...
#define LoReg		33
#define PCReg		34	// Current program LRU_timeser
#define NextPCReg	35	// Next program LRU_timeser (for branch delay) 
#define PrevPCReg	36	// Previous program LRU_timeser (for debugging)
...
// the contents of the TLB are free to be modified by the kernel software.
    ...
    bool usedPhyPage[NumPhysPages];//record which frame in the main memory is occupied.
    bool usedVirPage[NumPhysPages];
    
    // start for page replacement //
    int count[NumPhysPages]; //for LRU counter
